...
declare namespace Cypress {
  interface Chainable<> {
    ...
    /**
     * closes the dialog and waits for .bp6-dialog to not exist
     * @example
     * cy.closeDialog()
     */
    ...
    /**
     * Hides an open .bp6-menu or popover
     * @example
     * cy.hideMenu()
     */
    hideMenu(): void;
    ...
    setSliderToMax(sliderSelector: string): void;
    /**
     * deleteRange
