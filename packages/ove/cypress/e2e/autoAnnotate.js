describe("autoAnnotate", function () {
  ...
  it(`the auto annotation addon custom list should work`, () => {
    ...
    cy.contains(".bp6-dialog button", "Annotate").click();
    cy.contains(
    ...
    cy.contains(".bp6-dialog button", "Add").click();
    cy.contains(
  ...
  it(`the auto annotation ape upload addon should work`, () => {
    ...
    cy.uploadFile(`.bp6-dialog .tg-dropzone`, "Default_Features.txt");
    cy.contains(".bp6-dialog button", "Annotate").click();
    cy.contains(
  ...
  it(`the auto annotation csv upload addon should work`, () => {
    ...
    cy.get(`.bp6-radio input[name="forward"][value="true"]`);
