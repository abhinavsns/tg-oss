describe("menuBar", function () {
  ...
  it("Should be able to hide individual features", () => {
    ...
    cy.contains(".bp6-menu-item", "Features").trigger("mouseover");
    cy.contains(".bp6-menu-item", "Filter Individually")
      .contains("22/22")
      .trigger("mouseover", { force: true });
    cy.contains(".bp6-menu-item", "araD").click({ force: true });
    cy.contains(".bp6-menu-item", "araC").click({ force: true });
  ...
  it("Should be able to hide individual parts", () => {
    ...
    cy.contains(".bp6-menu-item", "Parts").trigger("mouseover");
    cy.contains(".bp6-menu-item", "Filter Individually")
      .contains("3/3")
      .trigger("mouseover", { force: true });
    cy.contains(".bp6-menu-item", "Part 0").click({ force: true });
    cy.contains(".veLabelText", "Part 0").should("not.exist");
    cy.contains(".bp6-menu-item", "Uncheck All").click({ force: true });
    cy.contains(".veLabelText", "Curtis' Part").should("not.exist");
    cy.contains(".bp6-menu-item", "Check All").click({ force: true });
    cy.contains(".veLabelText", "Part 0");
    cy.contains(".veLabelText", "Curtis' Part");
  });
  ...
  it("Should be able to filter part by length", () => {
    ...
    cy.contains(".bp6-menu-item", "Part").trigger("mouseover");
  ...
  it("Should be able to change circular/linear from the menu bar", () => {
    ...
    cy.contains(".bp6-menu-item", "Change Circular/Linear").trigger(
      "mouseover"
    );
    cy.get(":nth-child(2) > .bp6-menu-item").click({ force: true });
    cy.contains("Truncate Annotations").click();
    cy.get('[data-test="veStatusBar-circularity"] select').should(
      "have.value",
      "linear"
    );
  });
  ...
  it(`should be able to permanently change sequence case`, () => {
    ...
    cy.contains(".bp6-menu-item", "Change Case").trigger("mouseover");
    cy.contains(".bp6-menu-item", "Upper Case Sequence").click({ force: true });
    cy.contains(".rowViewTextContainer", "GACGTCTTATGA");
    cy.get(".tg-menu-bar").contains("Edit").click();
    cy.contains(".bp6-menu-item", "Change Case").trigger("mouseover");
    cy.contains(".bp6-menu-item", "Lower Case Sequence").click({ force: true });
    cy.contains(".rowViewTextContainer", "gacgtcttatga");
  });
  it(`should be able to permanently change selected sequence case`, () => {
    ...
    cy.contains(".bp6-menu-item", "Change Case").trigger("mouseover");
    cy.contains(".bp6-menu-item", "Upper Case Selection").click();
    cy.contains(".rowViewTextContainer", "gacgtcTTATGACAACTTGACGG");
  });
  ...
  //     .click();
  //   cy.contains(".rowViewTextContainer", "gacgtcttatga");
  //   cy.contains(".bp6-menu-item", "Sequence Case").trigger("mouseover");
  //   cy.contains(".bp6-menu-item", "Upper").click();
  //   cy.contains(".rowViewTextContainer", "GACGTCTTATGA");
  //   cy.contains(".bp6-menu-item", "Upper").click();
  //   cy.contains(".rowViewTextContainer", "gacgtcttatga");
  // });
  ...
  it(`should be able to filter by feature`, () => {
    ...
    cy.get(".tg-menu-bar").contains("View").click();
    cy.contains(".bp6-menu-item", "Features").trigger("mouseover");
    cy.contains(".bp6-menu-item", "Filter By Type")
      .contains("9/9")
      .trigger("mouseover", { force: true });
    cy.contains(".veLabelText", "araD");
    cy.contains(".veLabelText", "araC");
    cy.contains(".bp6-menu-item", "misc_feature").click({ force: true });
    cy.contains(".veLabelText", "araD").should("not.exist");
    cy.contains(".bp6-menu-item", "Filter By Type").contains("8/9");
    cy.contains(".bp6-menu-item", "Uncheck All").click({ force: true });
    cy.contains(".bp6-menu-item", "Filter By Type").contains("0/9");
    cy.contains(".veLabelText", "araC").should("not.exist");
    cy.contains(".bp6-menu-item", "Check All").click({ force: true });
    cy.contains(".veLabelText", "araC").should("exist");
  });
  it(`should be able to open the hotkeys dialog`, () => {
    ...
    cy.contains(".bp6-dialog", "Editor Hotkeys");
    cy.focused().type("{esc}", { force: true });
    cy.contains(".bp6-dialog", "Editor Hotkeys").should("not.exist");
  });
  it(`should be able to remove duplicate features`, () => {
    ...
    cy.contains(".bp6-dialog button", "Remove 2 Duplicates");
    cy.get(".bp6-dialog .bp6-icon-settings").click();
    ...
    cy.contains(".bp6-dialog button", "Remove 21 Duplicates").click();
    cy.contains(".veLabelText", "araD").should("not.exist");
  });

  it("should not be able to select a range in a length 0 sequence", function () {
    function shouldBeDisabled(text) {
      cy.contains(".bp6-menu-item", text).closest(".bp6-disabled");
    }
    cy.get(".tg-menu-bar").contains("Edit").click();
  ...
  it(`save tool should be disabled initially and then enabled after an edit is made`, () => {
    ...
    cy.get(`[cmd="saveSequence"]`).should("have.class", "bp6-disabled");
    ...
    cy.get(`[cmd="saveSequence"]`).should("not.have.class", "bp6-disabled");
  });
  ...
  `, () => {
    ...
    cy.get(".bp6-dialog input").clear().type("0", { noPrevValue: true });
    cy.get(".bp6-dialog").contains("OK").should("be.enabled");
    cy.get(".bp6-dialog input").clear().type("5299", { noPrevValue: true });
    cy.get(".bp6-dialog").contains("OK").should("be.enabled");
    cy.get(".bp6-dialog input").clear().type("2000000", { noPrevValue: true });
    cy.get(".bp6-dialog").contains("OK").should("be.disabled");
    cy.get(".bp6-dialog input").clear().type("20", { noPrevValue: true });
  ...
  `, () => {
    cy.get(".tg-menu-bar").contains("Edit").click();
    cy.get(".tg-menu-bar-popover").contains("Go To").click();
    cy.get(".bp6-dialog input").clear().type("10", { noPrevValue: true });
    cy.get(".bp6-dialog").contains("OK").click();
