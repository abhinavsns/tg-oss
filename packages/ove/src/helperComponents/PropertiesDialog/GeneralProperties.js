    ...
    return (
      <React.Fragment>
        <div className="ve-flex-row">
          <div className="ve-column-left bp6-label">Name</div>{" "}
        ...
        {!isProtein && !isOligo && !isRna && (
          <div className="ve-flex-row circularLinearSelect">
            <div className="ve-column-left bp6-label">Circular/Linear</div>{" "}
            <div className="ve-column-right">
              {" "}
        ...
        {showAvailability && (
          <div className="ve-flex-row">
            <div className="ve-column-left bp6-label">
        ...
        <div className="ve-flex-row">
          <div className="ve-column-left bp6-label">Length</div>{" "}
          <div className="ve-column-right">
            {" "}
        ...
        {showReadOnly && (
          <div className="ve-flex-row">
            <div className="ve-column-left bp6-label">Is Editable</div>{" "}
            <div className="ve-column-right">
              {" "}
              <EditReadOnlyItem
